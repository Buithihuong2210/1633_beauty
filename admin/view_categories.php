...
<table class="table table-bordered mt-5">
    ...
    <tbody class="bg-secondary text-light">
        ...
        <tr class="text-center">
            ...
            <td><a href='index.php?edit_categories=<?php echo $categories_id ?>' class='text-light'><i class='fa-regular fa-pen-to-square'></i></a></td>
            <td><a href='index.php?delete_categories=<?php echo $categories_id ?>' class='text-light'
